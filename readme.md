...
- ### Django-Allauth Google OneClick login
   1. [x] use http://128.0.0.1/ for the localhost. 
   #### resources:
   **Attention: This video has some bugs! Be careful!!** 
   -  https://www.youtube.com/watch?v=yO6PP0vEOMc
- ### Django-Allauth Github OAuth Login
   1. [x] use http://128.0.0.1/ for the localhost.
   #### resources:
   -  https://docs.allauth.org/en/dev/socialaccount/providers/github.html
   -  https://www.youtube.com/watch?v=RyB_wdEZhOw

## Install & Config webpack
   Using Webpack to optimize static resources (like Tailwind, and other CSS/JS files) in a Django project is a powerful way to improve performance and ensure a well-structured project. Below are step-by-step instructions on how to set up Webpack in your Django project for optimizing static resources.
